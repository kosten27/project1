        ...
        <div class="w3-container w3-padding">
            <div class="w3-card-4">
                ...
                <form method="post" action="/clients" class="w3-selection w3-light-grey w3-padding">
                    ...
                    <label>Age:
                        <input type="number" name="age" class="w3-input w3-border w3-round-large" style="width: 30%"><br />
                    </label>
                    <label>Phone:
                        <input type="text" name="phone" class="w3-input w3-border w3-round-large" style="width: 30%"><br />
                    </label>
                    <label>Email:
                        <input type="text" name="email" class="w3-input w3-border w3-round-large" style="width: 30%"><br />
                    </label>
